...
import { ArticlePreview } from '@/app/ui/components/features/article-preview/article-preview';

export const ArticlesPreviewCatalog: React.FC<ArticlesPreviewCatalogProps> = ({ className, children, ...props }) => {
